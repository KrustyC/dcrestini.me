const projects = [
  {
    ...
    description: `Learning Mangament System for primary school. Implemented as SAAS, the platform let admins and teachers 
    to create and review a curriculum bespoke to their pupils. I work as a fullstack developer, developing new features
  ...
  },
  {
    ...
    description: `Parental portal of Learnign Ladders. It offers children's parent the possibility to view
  ...
  {
    title: 'Muso',
    description: `Social network for musicians. The platform lets user find other musicians, events (to play at, or just attend)
  ...
  },
  {
    ...
    dates: '02/2018 - current',
    description: `Trying to create a general boilerplate, using NodeJs and GraphQL. The aim is to let people using this
  ...
  {
    title: 'Homypack',
    description: `This was a startup project I developed when I was still a student at University of Bologna. The 
    puprpose of the platform was to let online shoppers use places such post offices, minimarket, bars etc.. as 
